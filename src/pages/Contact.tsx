...
const Contact = ({ setSelectedPage }: Props) => {
    ...
    return (
        <div id='contact' ref={refInView} className='w-full min-h-screen flex items-center justify-center contrast-200
            ...
            <div className='relative flex flex-col items-start justify-start md:w-5/6 px-10'>
                <div className='w-full'>
                    <p className='uppercase text-xl px-4 tracking-widest text-lime-500'>
                    Contact
                    </p>
                    <p className='py-6 px-4 text-sm'>I am available for freelance or full-time positions. 
                ...
                <form
                    ...
                    <button type='submit' className='w-60 h-10 btn text-xl border-2 
                    border-gray-400'>
                        SUBMIT
                    </button>
                </form>
